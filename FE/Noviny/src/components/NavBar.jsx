  ...
  return (
    <nav>
      ...
      <div className="flex gap-5">
        <p className="cursor-pointer" onClick={() => onSelect("home")}>NOVINY.SK</p>
        <p className="cursor-pointer" onClick={() => onSelect("about")}>About</p>
        <p className="cursor-pointer" onClick={() => onSelect("articles")}>Articles</p>
      </div>
